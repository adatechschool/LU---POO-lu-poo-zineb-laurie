...
# nous avons créé les classes filles des différents types d'utilisateurs : 
...
class Admin(User):
    ...
    def can(self, permission: "Permission") -> bool:
        return True if permission == Permission.READ or permission == Permission.WRITE or permission == Permission.DELETE else False
...
class Writer(User):
    ...
    def can(self, permission: "Permission") -> bool:
        return True if permission == Permission.READ or permission == Permission.WRITE else False
...
def get_user(name: str) -> User:
    ...
    if USERS[name] == UserRole.ADMIN : 
        return Admin(name)
    elif USERS[name] == UserRole.WRITER:
        return Writer(name) 
    else:
        return Visitor(name)
